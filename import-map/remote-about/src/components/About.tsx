      ...
      <div className="about-grid">
        <div className="card">
          ...
          <p className="card-desc">
            ...
            각 UI 영역을 독립된 앱으로 분리하고, 브라우저 네이티브 Import Map으로 런타임에 동적으로 조합합니다.
          </p>
        </div>

        <div className="card">
          <h2 className="card-title">Phase 2: Import Map</h2>
          <div className="tech-list">
            {['Vite', 'Import Map', 'esm.sh CDN', 'TypeScript', 'pnpm workspace', 'vite-plugin-css-injected-by-js'].map(t => (
